...
<div class="toutu"><img src="${backstage}/<s:property value="#session.project.project_pic"/>"></div>
<div class="mian">
	<div class="contain">
    	<span class="STYLE2">尊敬的房天下网友：</span>
		<span class="STYLE2">今日预约已结束，请<hong><strong>明日</strong></hong>预约。预约时间：10:00-17:00，来带不便尽请谅解。</span>
